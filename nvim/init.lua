...
-- Set the Python 3 host program path to the Conda environment
vim.g.python3_host_prog = '/home/peaceofsense/miniconda3/envs/nvim-lsp/bin/python'

-- Configure LSP servers
local lspconfig = require'lspconfig'

-- Setup for pylsp (Python Language Server)
lspconfig.pylsp.setup{}

-- Setup for vim-language-server
